...
<div class="navbar">
    <div class="navbar-inner">
        ...
        <ul class="nav">
            <li><a href="/doLogout.html">退出</a></li>
        </ul>
        ...
        <ul style="padding-top: 10px">
            <li><a href="/mainAction.html">返回主界面</a></li>
        </ul>
    </div>
</div>

<div style="text-align:left;margin:0px auto;width:1200px; height:50px;">
    <form class="form-inline" action="/uploadFile.html" method="POST" enctype="multipart/form-data">
...
<script language="JavaScript">
    function averageCountTest(){
        window.showModalDialog("averageCountbox.jsp", "box", "dialogHeight: 200px; dialogWidth:400px; edge: Sunken; center: Yes; resizable: No; status: No;");
        alert("日志文件统计完成")

    }

    function wordCountTest(){
        window.showModalDialog("wordCountbox.jsp", "box", "dialogHeight: 200px; dialogWidth:400px; edge: Sunken; center: Yes; resizable: No; status: No;");
        alert("文件单词统计完成")
    }
